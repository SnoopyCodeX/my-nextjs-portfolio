...
export const metadata = {
  metadataBase: "https://snoopycodex.ph",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth dark">
      <body
        className={`${inter.className} bg-gray-50 text-gray-950 relative pt-28 sm:pt-36 dark:bg-[hsla(240deg, 20%, 20%, 1)] dark:text-gray-50 dark:text-opacity-90`}
      >
        {/*         
